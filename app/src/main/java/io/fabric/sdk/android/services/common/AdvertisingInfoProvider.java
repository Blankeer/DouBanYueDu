...
class AdvertisingInfoProvider {
    ...
    class AnonymousClass1 extends BackgroundPriorityRunnable {
        ...
        AnonymousClass1(AdvertisingInfo advertisingInfo) {
    ...
    protected AdvertisingInfo getInfoFromPreferences() {
        return new AdvertisingInfo(this.preferenceStore.get().getString(PREFKEY_ADVERTISING_ID, Table.STRING_DEFAULT_VALUE), this.preferenceStore.get().getBoolean(PREFKEY_LIMIT_AD_TRACKING, false));
    }
