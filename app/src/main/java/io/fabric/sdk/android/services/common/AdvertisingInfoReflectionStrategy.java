...
class AdvertisingInfoReflectionStrategy implements AdvertisingInfoStrategy {
    ...
    private String getAdvertisingId() {
        try {
            return (String) Class.forName(CLASS_NAME_ADVERTISING_ID_CLIENT_INFO).getMethod(METHOD_NAME_GET_ID, new Class[GOOGLE_PLAY_SERVICES_SUCCESS_CODE]).invoke(getInfo(), new Object[GOOGLE_PLAY_SERVICES_SUCCESS_CODE]);
        } catch (Exception e) {
    ...
    private boolean isLimitAdTrackingEnabled() {
        try {
            return ((Boolean) Class.forName(CLASS_NAME_ADVERTISING_ID_CLIENT_INFO).getMethod(METHOD_NAME_IS_LIMITED_AD_TRACKING_ENABLED, new Class[GOOGLE_PLAY_SERVICES_SUCCESS_CODE]).invoke(getInfo(), new Object[GOOGLE_PLAY_SERVICES_SUCCESS_CODE])).booleanValue();
        } catch (Exception e) {
