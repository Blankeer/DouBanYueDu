...
public class IdManager {
    ...
    public enum DeviceIdentifierType {
        ...
        FONT_TOKEN(53),
        ANDROID_ID(100),
        ANDROID_DEVICE_ID(Header.FLOAT),
        ANDROID_SERIAL(Header.DOUBLE_M1),
        ANDROID_ADVERTISING_ID(Header.DOUBLE_0);
    ...
    private String formatId(String id) {
        return id == null ? null : ID_PATTERN.matcher(id).replaceAll(Table.STRING_DEFAULT_VALUE).toLowerCase(Locale.US);
    }
    ...
    private String removeForwardSlashesIn(String s) {
        return s.replaceAll(FORWARD_SLASH_REGEX, Table.STRING_DEFAULT_VALUE);
    }

    public String getDeviceUUID() {
        String toReturn = Table.STRING_DEFAULT_VALUE;
        if (!this.collectHardwareIds) {
            return toReturn;
        }
