...
class DefaultSettingsJsonTransform implements SettingsJsonTransform {
    ...
    private AppSettingsData buildAppDataFrom(JSONObject json) throws JSONException {
        ...
        String url = json.getString(ShareUrlEditFragment_.URL_ARG);
    ...
    private JSONObject toAppJson(AppSettingsData appData) throws JSONException {
        JSONObject json = new JSONObject().put(SettingsJsonConstants.APP_IDENTIFIER_KEY, appData.identifier).put(SettingsJsonConstants.APP_STATUS_KEY, appData.status).put(ShareUrlEditFragment_.URL_ARG, appData.url).put(SettingsJsonConstants.APP_REPORTS_URL_KEY, appData.reportsUrl).put(SettingsJsonConstants.APP_UPDATE_REQUIRED_KEY, appData.updateRequired);
    ...
    private JSONObject toPromptJson(PromptSettingsData data) throws JSONException {
        return new JSONObject().put(QzoneShare.SHARE_TO_QQ_TITLE, data.title).put(GiftMessageEditFragment_.MESSAGE_ARG, data.message).put(SettingsJsonConstants.PROMPT_SEND_BUTTON_TITLE_KEY, data.sendButtonTitle).put(SettingsJsonConstants.PROMPT_SHOW_CANCEL_BUTTON_KEY, data.showCancelButton).put(SettingsJsonConstants.PROMPT_CANCEL_BUTTON_TITLE_KEY, data.cancelButtonTitle).put(SettingsJsonConstants.PROMPT_SHOW_ALWAYS_SEND_BUTTON_KEY, data.showAlwaysSendButton).put(SettingsJsonConstants.PROMPT_ALWAYS_SEND_BUTTON_TITLE_KEY, data.alwaysSendButtonTitle);
    }
}
