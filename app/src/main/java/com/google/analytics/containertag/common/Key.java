...
public enum Key {
    ...
    APP_NAME(NetWorker.PARAM_KEY_APP_NAME),
    ...
    PAGE(IntroPageFragment_.PAGE_ARG),
    PAGE_PATH("page_path"),
    PARTITION("partition"),
    PIXEL("pixel"),
    ...
    TITLE(QzoneShare.SHARE_TO_QQ_TITLE),
    ...
    URL(ShareUrlEditFragment_.URL_ARG),
    ...
    VALUE(DbCacheEntity.Column.VALUE),
