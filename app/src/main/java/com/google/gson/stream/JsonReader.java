...
public class JsonReader implements Closeable {
    ...
    private int peekNumber() throws IOException {
        ...
        while (true) {
            ...
            char c = buffer[p + i];
            switch (c) {
                case HeaderMapDB.COMPARATOR_DOUBLE_ARRAY /*43*/:
                    if (last != PEEKED_TRUE) {
                        return PEEKED_NONE;
                    }
                    last = PEEKED_FALSE;
                ...
                case HeaderMapDB.SERIALIZER_STRING_ASCII /*46*/:
                    if (last != PEEKED_END_OBJECT) {
                        return PEEKED_NONE;
                    }
                    last = PEEKED_BEGIN_ARRAY;
                    continue;
                case Header.LONG_MF2 /*69*/:
