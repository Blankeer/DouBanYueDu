...
public final class Downloads implements BaseColumns {
    ...
    public static boolean isStatusClientError(int i) {
        return i >= STATUS_BAD_REQUEST && i < StatConstant.DEFAULT_MAX_EVENT_COUNT;
    }

    public static boolean isStatusCompleted(int i) {
        return (i >= STATUS_SUCCESS && i < AppUri.READER) || (i >= STATUS_BAD_REQUEST && i < SettingsJsonConstants.ANALYTICS_FLUSH_INTERVAL_SECS_DEFAULT);
    }

    public static boolean isStatusError(int i) {
        return i >= STATUS_BAD_REQUEST && i < SettingsJsonConstants.ANALYTICS_FLUSH_INTERVAL_SECS_DEFAULT;
    }
    ...
    public static boolean isStatusSuccess(int i) {
        return i >= STATUS_SUCCESS && i < AppUri.READER;
    }
