...
public class b {
    ...
    static {
        a = new byte[]{(byte) 10, (byte) 1, dp.i, (byte) 5, (byte) 4, dp.m, (byte) 7, (byte) 9, (byte) 23, (byte) 3, (byte) 1, (byte) 6, (byte) 8, dp.j, dp.k, (byte) 91};
    }
    ...
    public static int a(int i, String str) {
        int i2;
        if (((double) new Random().nextFloat()) < 0.0010d) {
            if (str == null) {
                bt.b("--->", "null signature..");
            }
            i2 = 0;
            ...
            return (i2 | TransportMediator.FLAG_KEY_MEDIA_NEXT) * AppUri.OPEN_URL;
        }
