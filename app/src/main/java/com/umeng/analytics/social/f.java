...
public abstract class f {
    ...
    private static String a(List<NameValuePair> list) {
        try {
            ...
            new UrlEncodedFormEntity(list, HttpRequest.CHARSET_UTF8).writeTo(byteArrayOutputStream);
    ...
    private static String b(UMPlatformData... uMPlatformDataArr) {
        ...
        for (UMPlatformData uMPlatformData : uMPlatformDataArr) {
            ...
            jSONObject2.put(SelectCountryActivity.EXTRA_COUNTRY_NAME, name == null ? Table.STRING_DEFAULT_VALUE : String.valueOf(name));
        ...
        try {
            if (a(context, "android.permission.READ_PHONE_STATE")) {
                ...
                if (!TextUtils.isEmpty(d)) {
                    hashMap.put(StatConstant.JSON_KEY_MAC, d);
                }
