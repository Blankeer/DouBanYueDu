...
public class Tencent {
    ...
    public int login(Fragment fragment, String str, IUiListener iUiListener) {
        return this.mQQAuth.login(fragment, str, iUiListener, Table.STRING_DEFAULT_VALUE);
    }
    ...
    public int loginServerSide(Fragment fragment, String str, IUiListener iUiListener) {
        return this.mQQAuth.login(fragment, str + ",server_side", iUiListener, Table.STRING_DEFAULT_VALUE);
    }
    ...
    public void setAccessToken(String str, String str2) {
        f.a("openSDK_LOG", "setAccessToken(), expiresIn = " + str2 + Table.STRING_DEFAULT_VALUE);
