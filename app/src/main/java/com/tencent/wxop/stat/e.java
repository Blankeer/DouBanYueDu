...
public class e {
    ...
    private static f aK;
    private static volatile Map<b, Long> aL;
    private static volatile Map<String, Properties> aM;
    private static volatile Map<Integer, Integer> aN;
    ...
    private static UncaughtExceptionHandler aW;
    ...
    static {
        ...
        aN = new ConcurrentHashMap(10);
        aO = 0;
        af = 0;
        aP = 0;
        al = Table.STRING_DEFAULT_VALUE;
        aQ = 0;
        aR = Table.STRING_DEFAULT_VALUE;
        aS = Table.STRING_DEFAULT_VALUE;
    ...
    static void q(Context context) {
        aZ = System.currentTimeMillis() + ((long) (Constants.TIME_1MIN_MILLISECOND * c.u()));
