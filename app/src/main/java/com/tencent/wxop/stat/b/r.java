...
public final class r {
    ...
    public static String q(String str) {
        ...
        try {
            return new String(h.e(g.b(str.getBytes(HttpRequest.CHARSET_UTF8))), HttpRequest.CHARSET_UTF8);
        } catch (Throwable th) {
            Log.e("MtaSDK", "encode error", th);
            return str;
        }
    ...
    public static String t(String str) {
        ...
        try {
            return new String(g.c(h.d(str.getBytes(HttpRequest.CHARSET_UTF8))), HttpRequest.CHARSET_UTF8);
        } catch (Throwable th) {
