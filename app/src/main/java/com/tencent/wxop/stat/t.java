...
public class t {
    ...
    private String bq;
    private int cc;
    private ConcurrentHashMap<d, String> cd;
    private boolean ce;
    ...
    private t(Context context) {
        ...
        this.bX = null;
        this.be = null;
        this.ab = Table.STRING_DEFAULT_VALUE;
        this.bq = Table.STRING_DEFAULT_VALUE;
        this.aI = 0;
        this.bY = null;
        this.cc = 0;
        this.cd = null;
    ...
    private void I() {
        ...
        Throwable th;
        try {
            query = this.bW.getReadableDatabase().query(StatConstant.SP_KEY_CONFIG, null, null, null, null, null, null);
...
*/
    ...
    private synchronized void a(ah ahVar) {
        ...
        try {
            ...
            contentValues.put(WidgetRequestParam.REQ_PARAM_COMMENT_CONTENT, ahVar.df.toString());
            contentValues.put("md5sum", t);
            ahVar.c = t;
            contentValues.put(ShareRequestParam.REQ_PARAM_VERSION, Integer.valueOf(ahVar.L));
            query = this.bW.getReadableDatabase().query(StatConstant.SP_KEY_CONFIG, null, null, null, null, null, null);
            do {
                try {
                    if (!query.moveToNext()) {
            ...
            if (1 == obj) {
                update = (long) this.bW.getWritableDatabase().update(StatConstant.SP_KEY_CONFIG, contentValues, "type=?", new String[]{Integer.toString(ahVar.aI)});
            } else {
                contentValues.put(SocialConstants.PARAM_TYPE, Integer.valueOf(ahVar.aI));
                update = this.bW.getWritableDatabase().insert(StatConstant.SP_KEY_CONFIG, null, contentValues);
            }
            if (update == -1) {
...
*/
    ...
    private void b(boolean z) {
        ...
        try {
            ...
            ContentValues contentValues = new ContentValues();
            contentValues.put(SettingsJsonConstants.APP_STATUS_KEY, Integer.valueOf(1));
