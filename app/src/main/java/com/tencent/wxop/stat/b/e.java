    ...
    final void a(JSONObject jSONObject, Thread thread) {
        if (thread == null) {
            ...
            if (t.s(this.cB).t(this.cB) != null) {
                jSONObject.put(StatConstant.JSON_KEY_USERID, t.s(this.cB).t(this.cB).b());
            }
        ...
        r.a(jSONObject, StatConstant.JSON_KEY_SDK_VERSION, this.b);
        r.a(jSONObject, "osd", Build.DISPLAY);
        r.a(jSONObject, "prod", Build.PRODUCT);
        r.a(jSONObject, "tags", Build.TAGS);
        r.a(jSONObject, WorksListUri.KEY_ID, Build.ID);
        r.a(jSONObject, "fng", Build.FINGERPRINT);
        r.a(jSONObject, "lch", this.aS);
        r.a(jSONObject, "ov", Integer.toString(this.L));
        jSONObject.put(StatConstant.JSON_KEY_OS, 1);
        r.a(jSONObject, "op", this.bs);
        r.a(jSONObject, "lg", this.bq);
        r.a(jSONObject, "md", this.M);
        r.a(jSONObject, StatConstant.JSON_KEY_TIMEZONE, this.bt);
        if (this.aQ != 0) {
            jSONObject.put("jb", this.aQ);
        }
        r.a(jSONObject, "sd", this.al);
        r.a(jSONObject, StatConstant.JSON_KEY_APP_NAME, this.aR);
