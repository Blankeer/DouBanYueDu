...
public class AsynLoadImg {
    ...
    class AnonymousClass1 extends Handler {
        ...
        AnonymousClass1(AsynLoadImg asynLoadImg, Looper looper) {
            this.a = asynLoadImg;
            super(looper);
        }
    ...
    public AsynLoadImg(Activity activity) {
        ...
        this.e = new AnonymousClass1(this, activity.getMainLooper());
    }

    public void save(String str, AsynLoadImgBack asynLoadImgBack) {
        f.a("AsynLoadImg", "--save---");
        if (str == null || str.equals(Table.STRING_DEFAULT_VALUE)) {
