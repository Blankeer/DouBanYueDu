...
public class SystemUtils {
    ...
    public static String getAppSignatureMD5(Context context, String str) {
        ...
        try {
            ...
            instance.update(Util.getBytesUTF8(packageName + EventsFilesManager.ROLL_OVER_FILE_NAME_SEPARATOR + toHexString + EventsFilesManager.ROLL_OVER_FILE_NAME_SEPARATOR + str + Table.STRING_DEFAULT_VALUE));
    ...
    public static boolean extractSecureLib(String str, String str2, int i) {
        ...
        if (file.exists()) {
            int i2 = sharedPreferences.getInt(ShareRequestParam.REQ_PARAM_VERSION, 0);
