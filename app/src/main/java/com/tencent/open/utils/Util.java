...
public class Util {
    ...
    static class AnonymousClass1 extends Thread {
        ...
        public void run() {
            try {
                HttpUtils.openUrl2(this.a, "http://cgi.qplus.com/report/report", HttpRequest.METHOD_GET, this.b);
            } catch (Exception e) {
    ...
    static {
        a = "openSDK_LOG." + Util.class.getName();
    ...
    public static String encodePostBody(Bundle bundle, String str) {
        ...
        for (String str2 : bundle.keySet()) {
            ...
            if (obj instanceof String) {
                stringBuilder.append("Content-Disposition: form-data; name=\"" + str2 + "\"" + Char.CRLF + Char.CRLF + ((String) obj));
                if (i2 < size - 1) {
    ...
    public static Statistic upload(Context context, String str, Bundle bundle) throws MalformedURLException, IOException, NetworkUnavailableException, HttpStatusException {
        ...
        if (!bundle3.isEmpty()) {
            ...
            for (String str222 : bundle3.keySet()) {
                i++;
                byteArrayOutputStream.write(getBytesUTF8("Content-Disposition: form-data; name=\"" + str222 + "\"; filename=\"" + "value.file" + "\"" + Char.CRLF));
    ...
    public static boolean isMobileQQSupportShare(Context context) {
        try {
            if (SystemUtils.compareVersion(context.getPackageManager().getPackageInfo(Constants.PACKAGE_QQ, 0).versionName, "4.1") >= 0) {
                return true;
            }
            return false;
        } catch (NameNotFoundException e) {
            f.b("checkMobileQQ", StatConstant.STAT_EVENT_ID_ERROR);
            return false;
        }
    }
    ...
    public static String toHexString(byte[] bArr) {
        ...
        for (byte b : bArr) {
            String num = Integer.toString(b & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT, 16);
            if (num.length() == 1) {
    ...
    public static String hexToString(String str) {
        ...
        while (i < bArr.length) {
            try {
                bArr[i] = (byte) (Integer.parseInt(str.substring(i * 2, (i * 2) + 2), 16) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT);
            } catch (Exception e) {
    ...
    public static final String subString(String str, int i, String str2, String str3) {
        ...
        String str4 = HttpRequest.CHARSET_UTF8;
    ...
    public static Bundle composeViaReportParams(String str, String str2, String str3, String str4, String str5, String str6) {
        return composeViaReportParams(str, str3, str4, str2, str5, str6, Table.STRING_DEFAULT_VALUE, Table.STRING_DEFAULT_VALUE, Table.STRING_DEFAULT_VALUE, Table.STRING_DEFAULT_VALUE, Table.STRING_DEFAULT_VALUE, Table.STRING_DEFAULT_VALUE);
    }
    ...
    public static Bundle composeHaboCgiReportParams(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9) {
        ...
        bundle.putString(SelectCountryActivity.EXTRA_COUNTRY_CODE, str2);
