...
public class OpenConfig {
    private static HashMap<String, OpenConfig> a;
    ...
    class AnonymousClass1 extends Thread {
        ...
        AnonymousClass1(OpenConfig openConfig, Bundle bundle) {
            this.b = openConfig;
            this.a = bundle;
        }
        ...
        public void run() {
            try {
                this.b.a(Util.parseJson(HttpUtils.openUrl2(this.b.c, "http://cgi.connect.qq.com/qqconnectopen/openapi/policy_conf", HttpRequest.METHOD_GET, this.a).response));
            } catch (Exception e) {
                e.printStackTrace();
            }
            this.b.g = 0;
    ...
    private void a(String str, String str2) {
        try {
            ...
            OutputStreamWriter outputStreamWriter = new OutputStreamWriter(this.c.openFileOutput(str, 0), Charset.forName(HttpRequest.CHARSET_UTF8));
    ...
    private void b() {
        ...
        new AnonymousClass1(this, bundle).start();
    }
    ...
    private void c() {
        ...
        if (SystemClock.elapsedRealtime() - this.f >= ((long) (optInt * com.douban.book.reader.constant.Constants.TIME_1HOUR_MILLISECOND))) {
            b();
        }
    }
