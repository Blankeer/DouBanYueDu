...
public class a extends i implements Callback {
    ...
    public void a() {
        if (this.k.hasMessages(AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT)) {
            this.k.removeMessages(AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT);
        }
        this.k.sendEmptyMessage(AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT);
    }
