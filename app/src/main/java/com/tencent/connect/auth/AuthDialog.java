...
public class AuthDialog extends Dialog {
            ...
            if (str.startsWith(AuthConstants.REDIRECT_BROWSER_URI)) {
                ...
                if (!this.a.m) {
                    if (parseUrlToJson.optString("fail_cb", null) != null) {
                        this.a.callJs(parseUrlToJson.optString("fail_cb"), Table.STRING_DEFAULT_VALUE);
    ...
    private void c() {
        ...
        if (this.i.equals(SystemUtils.ACTION_LOGIN)) {
            ...
            view.setTextColor(Color.rgb(SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT, SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT, SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT));
