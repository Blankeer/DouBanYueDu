...
public class AssistActivity extends Activity {
    ...
    public static boolean hackAuthActivity;
    ...
    protected void onNewIntent(Intent intent) {
        ...
        Object obj = TemporaryStorage.get(intent.getStringExtra(DoubanAccountOperationFragment_.ACTION_ARG));
        ...
        if (activity != null) {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(stringExtra)) {
                    ...
                    CharSequence optString2 = jSONObject.optString(ShareRequestParam.REQ_PARAM_TOKEN);
    ...
    private void openBrowser(Bundle bundle) {
        ...
        String string3 = bundle.getString(ShareUrlEditFragment_.URL_ARG);
