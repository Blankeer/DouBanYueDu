...
public class QzoneShare extends BaseApi {
    ...
    class AnonymousClass1 implements AsynLoadImgBack {
        ...
        AnonymousClass1(QzoneShare qzoneShare, Bundle bundle, Activity activity, IUiListener iUiListener) {
            this.d = qzoneShare;
            this.a = bundle;
            this.b = activity;
            this.c = iUiListener;
        ...
        public void batchSaved(int i, ArrayList<String> arrayList) {
            if (i == 0) {
                this.a.putStringArrayList(QzoneShare.SHARE_TO_QQ_IMAGE_URL, arrayList);
            }
    ...
    public QzoneShare(Context context, QQToken qQToken) {
        super(qQToken);
        this.mViaShareQzoneType = Table.STRING_DEFAULT_VALUE;
        this.a = true;
        this.b = false;
        this.c = false;
        this.d = false;
    ...
    public void shareToQzone(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        if (Util.hasSDCard() || SystemUtils.compareQQVersion(activity, SystemUtils.QQ_VERSION_NAME_4_5_0) >= 0) {
            ...
            if (this.b) {
                ...
                string3 = Table.STRING_DEFAULT_VALUE;
                ...
                if (!Util.isEmpty(string2) && string2.length() > SettingsJsonConstants.ANALYTICS_FLUSH_INTERVAL_SECS_DEFAULT) {
                    bundle.putString(SHARE_TO_QQ_SUMMARY, Util.subString(string2, SettingsJsonConstants.ANALYTICS_FLUSH_INTERVAL_SECS_DEFAULT, null, null));
                }
            }
            ...
            if (SystemUtils.compareQQVersion(activity, SystemUtils.QQ_VERSION_NAME_4_6_0) >= 0) {
                a.a((Context) activity, stringArrayList, new AnonymousClass1(this, bundle, activity, iUiListener));
    ...
    private void a(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        if (hasActivityForIntent()) {
            ...
            d.a().a(0, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String.valueOf(4), Long.valueOf(SystemClock.elapsedRealtime()), 0, SHARE_TO_QZONE_TYPE_IMAGE_TEXT, Table.STRING_DEFAULT_VALUE);
        } else {
