...
public class QQShare extends BaseApi {
    ...
    class AnonymousClass1 implements AsynLoadImgBack {
        ...
        AnonymousClass1(QQShare qQShare, Bundle bundle, String str, String str2, IUiListener iUiListener, Activity activity) {
            this.f = qQShare;
            this.a = bundle;
            this.b = str;
            this.c = str2;
        ...
        public void saved(int i, String str) {
            if (i == 0) {
                this.a.putString(QQShare.SHARE_TO_QQ_IMAGE_LOCAL_URL, str);
    ...
    class AnonymousClass2 implements AsynLoadImgBack {
        final /* synthetic */ Bundle a;
        final /* synthetic */ String b;
        final /* synthetic */ String c;
        final /* synthetic */ IUiListener d;
        ...
        AnonymousClass2(QQShare qQShare, Bundle bundle, String str, String str2, IUiListener iUiListener, Activity activity) {
            this.f = qQShare;
            this.a = bundle;
            this.b = str;
            this.c = str2;
    ...
    public QQShare(Context context, QQToken qQToken) {
        super(qQToken);
        this.mViaShareQQType = Table.STRING_DEFAULT_VALUE;
    }
        ...
        if (Util.hasSDCard() || SystemUtils.compareQQVersion(activity, SystemUtils.QQ_VERSION_NAME_4_5_0) >= 0) {
            ...
            if (TextUtils.isEmpty(string) || string.startsWith("http://") || string.startsWith("https://") || new File(string).exists()) {
                ...
                if (Util.isMobileQQSupportShare(activity)) {
                    ...
                    new TDialog(activity, Table.STRING_DEFAULT_VALUE, getCommonDownloadQQUrl(Table.STRING_DEFAULT_VALUE), null, this.mToken).show();
                }
    ...
    private void a(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        if (TextUtils.isEmpty(string)) {
            ...
            if (SystemUtils.compareQQVersion(activity, SystemUtils.QQ_VERSION_NAME_4_3_0) < 0) {
                ...
                f.b("openSDK_LOG.QQShare", "shareToMobileQQ -- QQ Version is > 4.3.0 ");
                a.a((Context) activity, string, new AnonymousClass2(this, bundle, string2, string3, iUiListener, activity));
            }
            ...
            new AsynLoadImg(activity).save(string, new AnonymousClass1(this, bundle, string2, string3, iUiListener, activity));
        }
    ...
    private void b(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        a.a(Global.getContext(), this.mToken, "requireApi", strArr);
        ...
        if (hasActivityForIntent()) {
            ...
            d.a().a(0, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, SHARE_TO_QQ_TYPE_DEFAULT, Table.STRING_DEFAULT_VALUE);
        } else {
