    ...
    public static class Req extends BaseReq {
        ...
        public boolean checkArgs() {
            ...
            for (WXCardItem wXCardItem : this.cardArrary) {
                if (wXCardItem == null || wXCardItem.cardId == null || wXCardItem.cardId.length() > AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT || (wXCardItem.cardExtMsg != null && wXCardItem.cardExtMsg.length() > AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT)) {
                    return false;
                }
            }
            return true;
        ...
        public void toBundle(Bundle bundle) {
            ...
            try {
                ...
                for (WXCardItem wXCardItem : this.cardArrary) {
                    ...
                    jSONStringer.value(wXCardItem.cardExtMsg == null ? Table.STRING_DEFAULT_VALUE : wXCardItem.cardExtMsg);
