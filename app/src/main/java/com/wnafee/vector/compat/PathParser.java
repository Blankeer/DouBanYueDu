...
public class PathParser {
    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] current, char previousCmd, char cmd, float[] val) {
            ...
            switch (cmd) {
                case Header.LONG_MIN_VALUE /*65*/:
                case Header.FLOAT_0 /*97*/:
                    incr = 7;
                    break;
                case Header.LONG_MF1 /*67*/:
                case Header.FLOAT_255 /*99*/:
                    incr = 6;
                    break;
                case Header.LONG_F3 /*72*/:
                case Header.CHAR_0 /*86*/:
                case Header.DOUBLE_1 /*104*/:
                case Header.ARRAY_INT_PACKED /*118*/:
                    incr = 1;
                    break;
                case Header.LONG_F5 /*76*/:
                case Header.LONG_MF6 /*77*/:
                case Header.BYTE_1 /*84*/:
    ...
    L_0x0019:
        ...
        goto L_0x0000;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.wnafee.vector.compat.PathParser.nextStart(java.lang.String, int):int");
    }
