...
public final class e {
    ...
    static {
        a = null;
        b = new String[]{"AD1", "AD2", "AD3", "AD5", "AD6", "AD7", "AD8", "AD9", "AD10", "AD11", "AD12", "AD13", "AD14", "AD15", "AD16", "AD18", "AD19", "AD20", "AD21", "AL3", "AA1", "AA2", "AA3", "AA4", "AA5", "AC1", "AC2", "AC4", "AE1", "AE2", "AE3", "AE4", "AE5", "AE6", "AE7", "AE8", "AE9", "AE10", "AE11", "AE12", "AE13", "AE14", "AE15"};
    }
    ...
    private static String a(Map<String, String> map) {
        ...
        while (i < arrayList.size()) {
            ...
            stringBuffer.append((i == 0 ? Table.STRING_DEFAULT_VALUE : "&") + str + SimpleComparison.EQUAL_TO_OPERATION + ((String) map.get(str)));
            i++;
        }
