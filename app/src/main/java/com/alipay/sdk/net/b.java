...
public final class b {
    ...
    public static b a() {
        if (b == null) {
            ...
            HttpConnectionParams.setSocketBufferSize(basicHttpParams, AccessibilityNodeInfoCompat.ACTION_COPY);
            ...
            try {
                ...
                Scheme scheme = new Scheme(Constants.API_SCHEME, socketFactory, 443);
