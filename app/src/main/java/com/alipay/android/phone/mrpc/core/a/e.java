...
public final class e extends b {
    ...
    public final byte[] a() {
        try {
            ...
            arrayList.add(new BasicNameValuePair(WorksListUri.KEY_ID, this.c));
            ...
            Throwable th = e;
            throw new c(Integer.valueOf(9), new StringBuilder("request  =").append(this.b).append(":").append(th).toString() == null ? Table.STRING_DEFAULT_VALUE : th.getMessage(), th);
        }
    }
}
