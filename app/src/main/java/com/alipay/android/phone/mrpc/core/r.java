...
public final class r {
    ...
    private static int c(String str) {
        switch (((Character.toLowerCase(str.charAt(0)) + Character.toLowerCase(str.charAt(1))) + Character.toLowerCase(str.charAt(2))) - 291) {
            ...
            case TransportMediator.FLAG_KEY_MEDIA_STOP /*32*/:
                return 3;
            case HeaderMapDB.HASHER_CHAR_ARRAY /*35*/:
                return 9;
    ...
    private static int d(String str) {
        if (str.length() != 2) {
            return str.length() == 3 ? ((((str.charAt(0) - 48) * 100) + ((str.charAt(1) - 48) * 10)) + (str.charAt(2) - 48)) + 1900 : str.length() == 4 ? ((((str.charAt(0) - 48) * AppUri.OPEN_URL) + ((str.charAt(1) - 48) * 100)) + ((str.charAt(2) - 48) * 10)) + (str.charAt(3) - 48) : 1970;
        } else {
