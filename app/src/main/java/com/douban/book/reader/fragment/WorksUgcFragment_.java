...
public final class WorksUgcFragment_ extends WorksUgcFragment implements HasViews, OnViewChangedListener {
    ...
    /* renamed from: com.douban.book.reader.fragment.WorksUgcFragment_.1 */
    class AnonymousClass1 implements Runnable {
        final /* synthetic */ boolean val$showAnnotation;

        AnonymousClass1(boolean z) {
            this.val$showAnnotation = z;
        }

        public void run() {
            super.updateViews(this.val$showAnnotation);
        }
    }

    /* renamed from: com.douban.book.reader.fragment.WorksUgcFragment_.2 */
    ...
    public static class FragmentBuilder_ extends FragmentBuilder<FragmentBuilder_, WorksUgcFragment> {
        ...
        public FragmentBuilder_ worksId(int worksId) {
            this.args.putInt(WorksUgcFragment_.WORKS_ID_ARG, worksId);
            return this;
        }
    ...
    void updateViews(boolean showAnnotation) {
        UiThreadExecutor.runTask(Table.STRING_DEFAULT_VALUE, new AnonymousClass1(showAnnotation), 0);
    }
