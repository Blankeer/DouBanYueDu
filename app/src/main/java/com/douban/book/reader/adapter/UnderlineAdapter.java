...
public class UnderlineAdapter extends BaseArrayAdapter<Annotation> implements StickyListHeadersAdapter {
    private int mWorksId;

    public UnderlineAdapter(Context context, int worksId, List<Annotation> annotationList) {
    ...
    protected void bindView(View itemView, Annotation item) {
        ((UgcItemView) itemView).setAnnotation(item);
    }
