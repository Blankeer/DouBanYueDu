...
public class PersistentConfiguration {
    ...
    public PersistentConfiguration(Context context, String str, String str2, boolean z, boolean z2) {
        ...
        MyEditor edit2;
        long j2;
        this.mConfigName = Table.STRING_DEFAULT_VALUE;
        this.mFolderName = Table.STRING_DEFAULT_VALUE;
        ...
        if (context != null) {
            ...
            j3 = this.mSp.getLong(KEY_TIMESTAMP, 0);
        }
        ...
        if (!StringUtils.isEmpty(externalStorageState)) {
            ...
            if (!((!this.mCanRead && !this.mCanWrite) || context == null || StringUtils.isEmpty(str))) {
                ...
                if (this.mTxf != null) {
                    try {
                        ...
                        j4 = this.mMySP.getLong(KEY_TIMESTAMP, 0);
                        if (!z2) {
            ...
            if (j3 == j4 || (j3 == 0 && j4 == 0)) {
                j = System.currentTimeMillis();
                if (this.mIsLessMode || (this.mIsLessMode && j3 == 0 && j4 == 0)) {
                    if (this.mSp != null) {
                        edit = this.mSp.edit();
                        edit.putLong(KEY_TIMESTAMP2, j);
                        edit.commit();
    ...
    public String getString(String str) {
        checkSDCardXMLFile();
        if (this.mSp != null) {
            String string = this.mSp.getString(str, Table.STRING_DEFAULT_VALUE);
            if (!StringUtils.isEmpty(string)) {
                return string;
            }
        }
        if (this.mMySP != null) {
            return this.mMySP.getString(str, Table.STRING_DEFAULT_VALUE);
        }
