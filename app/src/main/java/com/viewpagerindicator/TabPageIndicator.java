...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    class AnonymousClass2 implements Runnable {
        ...
        public void run() {
            TabPageIndicator.this.smoothScrollTo(this.val$tabView.getLeft() - ((TabPageIndicator.this.getWidth() - this.val$tabView.getWidth()) / 2), 0);
    ...
    static {
        EMPTY_TITLE = Table.STRING_DEFAULT_VALUE;
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (childCount <= 1 || !(widthMode == 1073741824 || widthMode == ExploreByTouchHelper.INVALID_ID)) {
            ...
            this.mMaxTabWidth = (int) (((float) MeasureSpec.getSize(widthMeasureSpec)) * CharUtils.FULL_WIDTH_CHAR_OFFSET_ADJUSTMENT_RATIO);
        } else {
    ...
    private void animateToTab(int position) {
        ...
        this.mTabSelector = new AnonymousClass2(tabView);
