...
public class UnderlinePageIndicator extends View implements PageIndicator {
    ...
    public void setFades(boolean fades) {
        if (fades != this.mFades) {
            ...
            this.mPaint.setAlpha(SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT);
            invalidate();
        }
    }
    ...
    public void setFadeLength(int fadeLength) {
        ...
        this.mFadeBy = SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT / (this.mFadeLength / FADE_FRAME_MS);
    }
