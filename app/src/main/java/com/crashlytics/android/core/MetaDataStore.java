...
class MetaDataStore {
    ...
    static class AnonymousClass1 extends JSONObject {
        final /* synthetic */ UserMetaData val$userData;

        AnonymousClass1(UserMetaData userMetaData) throws JSONException {
    ...
    private static String userDataToJson(UserMetaData userData) throws JSONException {
        return new AnonymousClass1(userData).toString();
    }
