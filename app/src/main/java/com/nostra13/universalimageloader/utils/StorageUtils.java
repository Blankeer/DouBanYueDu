...
public final class StorageUtils {
    ...
    public static File getCacheDirectory(Context context, boolean preferExternal) {
        ...
        try {
            ...
            externalStorageState = Table.STRING_DEFAULT_VALUE;
    ...
    private static File getExternalCacheDir(Context context) {
        File appCacheDir = new File(new File(new File(new File(Environment.getExternalStorageDirectory(), a.b), ShareRequestParam.RESP_UPLOAD_PIC_PARAM_DATA), context.getPackageName()), DbCacheEntity.TABLE_NAME);
