...
public class TokenQueue {
    ...
    public String consumeTagName() {
        int start = this.pos;
        while (!isEmpty() && (matchesWord() || matchesAny(':', Char.UNDERLINE, Char.HYPHEN))) {
            this.pos++;
        }
        return this.queue.substring(start, this.pos);
    }
    ...
    public String consumeElementSelector() {
        int start = this.pos;
        while (!isEmpty() && (matchesWord() || matchesAny(Char.PIPE, Char.UNDERLINE, Char.HYPHEN))) {
            this.pos++;
        }
        return this.queue.substring(start, this.pos);
    }
    ...
    public String consumeCssIdentifier() {
        int start = this.pos;
        while (!isEmpty() && (matchesWord() || matchesAny(Char.HYPHEN, Char.UNDERLINE))) {
            this.pos++;
        }
        return this.queue.substring(start, this.pos);
    }
