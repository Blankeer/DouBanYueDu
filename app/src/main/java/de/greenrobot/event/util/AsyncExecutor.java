...
public class AsyncExecutor {
    ...
    /* renamed from: de.greenrobot.event.util.AsyncExecutor.1 */
    ...
    public static class Builder {
        ...
        public AsyncExecutor buildForScope(Object executionContext) {
            ...
            return new AsyncExecutor(this.eventBus, this.failureEventType, executionContext, null);
        }
    }
    ...
    public void execute(RunnableEx runnable) {
        this.threadPool.execute(new AnonymousClass1(runnable));
    }
}
