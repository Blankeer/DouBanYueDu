...
public class SwitchCompat extends CompoundButton {
    ...
    private void stopDrag(MotionEvent ev) {
        ...
        if (commitChange) {
            this.mVelocityTracker.computeCurrentVelocity(AppUri.OPEN_URL);
    ...
    private void animateThumbToCheckedState(boolean newCheckedState) {
        ...
        this.mPositionAnimator.setAnimationListener(new AnonymousClass1(newCheckedState));
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        switch (getGravity() & Header.ARRAY_SHORT) {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        if (VERSION.SDK_INT >= 14) {
            ...
            if (!TextUtils.isEmpty(switchText)) {
                ...
                newText.append(oldText).append(Char.SPACE).append(switchText);
