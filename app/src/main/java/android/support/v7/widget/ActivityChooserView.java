...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    private class Callbacks implements OnItemClickListener, OnClickListener, OnLongClickListener, OnDismissListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            switch (((ActivityChooserViewAdapter) parent.getAdapter()).getItemViewType(position)) {
                ...
                case dx.b /*1*/:
                    ActivityChooserView.this.showPopupUnchecked(AdvancedShareActionProvider.WEIGHT_MAX);
                default:
                    throw new IllegalArgumentException();
            }
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        expandButton.setOnTouchListener(new AnonymousClass3(expandButton));
    ...
    private void showPopupUnchecked(int maxActivityCount) {
        ...
        if (maxActivityCount == AdvancedShareActionProvider.WEIGHT_MAX || activityCount <= maxActivityCount + maxActivityCountOffset) {
