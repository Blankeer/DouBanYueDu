...
public class Toolbar extends ViewGroup {
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (Toolbar.this.mExpandedActionView.getParent() != Toolbar.this) {
                ...
                lp.gravity = GravityCompat.START | (Toolbar.this.mButtonGravity & Header.ARRAY_SHORT);
                lp.mViewType = 2;
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int contentInsetStart = a.getDimensionPixelOffset(R.styleable.Toolbar_contentInsetStart, ExploreByTouchHelper.INVALID_ID);
        int contentInsetEnd = a.getDimensionPixelOffset(R.styleable.Toolbar_contentInsetEnd, ExploreByTouchHelper.INVALID_ID);
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            lp.gravity = GravityCompat.END | (this.mButtonGravity & Header.ARRAY_SHORT);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams lp = generateDefaultLayoutParams();
            lp.gravity = GravityCompat.START | (this.mButtonGravity & Header.ARRAY_SHORT);
    ...
    private int getChildVerticalGravity(int gravity) {
        int vgrav = gravity & Header.ARRAY_SHORT;
        switch (vgrav) {
            ...
            case Header.LONG_F7 /*80*/:
                return vgrav;
            default:
                return this.mGravity & Header.ARRAY_SHORT;
        }
    }
