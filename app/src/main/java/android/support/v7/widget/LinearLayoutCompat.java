...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public int getBaseline() {
        ...
        if (childBaseline != -1) {
            ...
            if (this.mOrientation == VERTICAL) {
                int majorGravity = this.mGravity & Header.ARRAY_SHORT;
                if (majorGravity != 48) {
                    switch (majorGravity) {
            ...
            if (child == null) {
                ...
                if (baselineAligned) {
                    ...
                    if (childBaseline != -1) {
                        ...
                        int index = (((i & Header.ARRAY_SHORT) >> VERTICAL_GRAVITY_COUNT) & -2) >> VERTICAL;
                ...
                if (!(child == null || child.getVisibility() == 8)) {
                    ...
                    if (baselineAligned) {
                        ...
                        if (childBaseline != -1) {
                            ...
                            index = (((i & Header.ARRAY_SHORT) >> VERTICAL_GRAVITY_COUNT) & -2) >> VERTICAL;
                            maxAscent[index] = Math.max(maxAscent[index], childBaseline);
                            maxDescent[index] = Math.max(maxDescent[index], childHeight - childBaseline);
                        }
                    }
    ...
    void layoutVertical(int left, int top, int right, int bottom) {
        ...
        switch (this.mGravity & Header.ARRAY_SHORT) {
            case TransportMediator.FLAG_KEY_MEDIA_PAUSE /*16*/:
    ...
    void layoutHorizontal(int left, int top, int right, int bottom) {
        ...
        int minorGravity = this.mGravity & Header.ARRAY_SHORT;
        boolean baselineAligned = this.mBaselineAligned;
        int[] maxAscent = this.mMaxAscent;
        int[] maxDescent = this.mMaxDescent;
        ...
        while (i < count) {
            ...
            if (child == null) {
                ...
                switch (gravity & Header.ARRAY_SHORT) {
                    case TransportMediator.FLAG_KEY_MEDIA_PAUSE /*16*/:
    ...
    public void setGravity(int gravity) {
        if (this.mGravity != gravity) {
            ...
            if ((gravity & Header.ARRAY_SHORT) == 0) {
                gravity |= 48;
            }
    ...
    public void setVerticalGravity(int verticalGravity) {
        int gravity = verticalGravity & Header.ARRAY_SHORT;
        if ((this.mGravity & Header.ARRAY_SHORT) != gravity) {
