...
import com.douban.book.reader.content.paragraph.Formula;
...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    static {
        ...
        DECELERATE_QUINT = new DecelerateInterpolator(Formula.SIZE3_RATIO);
        DECELERATE_CUBIC = new DecelerateInterpolator(1.5f);
        ACCELERATE_QUINT = new AccelerateInterpolator(Formula.SIZE3_RATIO);
