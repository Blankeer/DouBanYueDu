...
public class PagerTitleStrip extends ViewGroup implements Decor {
    ...
    public void setNonPrimaryAlpha(@FloatRange(from = 0.0d, to = 1.0d) float alpha) {
        this.mNonPrimaryAlpha = ((int) (255.0f * alpha)) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT;
    ...
    void updateText(int currentItem, PagerAdapter adapter) {
        ...
        int childWidthSpec = MeasureSpec.makeMeasureSpec(Math.max(0, (int) (((float) ((getWidth() - getPaddingLeft()) - getPaddingRight())) * Paragraph.CODE_TEXTSIZE_RATIO)), ExploreByTouchHelper.INVALID_ID);
