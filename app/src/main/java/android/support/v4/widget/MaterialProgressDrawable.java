...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static class Ring {
        ...
        public void draw(Canvas c, Rect bounds) {
            ...
            if (this.mAlpha < SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) {
    ...
    private int evaluateColorChange(float fraction, int startValue, int endValue) {
        ...
        int startA = (startInt >> 24) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT;
        int startR = (startInt >> 16) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT;
        int startG = (startInt >> 8) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT;
        int startB = startInt & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT;
        int endInt = Integer.valueOf(endValue).intValue();
        return ((((((int) (((float) (((endInt >> 24) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) - startA)) * fraction)) + startA) << 24) | ((((int) (((float) (((endInt >> 16) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) - startR)) * fraction)) + startR) << 16)) | ((((int) (((float) (((endInt >> 8) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) - startG)) * fraction)) + startG) << 8)) | (((int) (((float) ((endInt & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) - startB)) * fraction)) + startB);
    }
