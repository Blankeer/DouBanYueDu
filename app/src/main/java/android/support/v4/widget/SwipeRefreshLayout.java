...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        this.mProgress.setProgressRotation(((-0.25f + (CharUtils.FULL_WIDTH_CHAR_OFFSET_ADJUSTMENT_RATIO * adjustedPercent)) + (DECELERATE_INTERPOLATION_FACTOR * tensionPercent)) * DRAG_RATE);
