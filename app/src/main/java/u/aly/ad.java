...
public class ad {
    ...
    public void a(Context context) {
        ...
        Editor edit = a.edit();
        if (this.c.size() > 0) {
            Object string = a.getString(a, Table.STRING_DEFAULT_VALUE);
    ...
    public static List<bi> a(SharedPreferences sharedPreferences) {
        String string = sharedPreferences.getString(a, Table.STRING_DEFAULT_VALUE);
        if (Table.STRING_DEFAULT_VALUE.equals(string)) {
            return null;
        }
