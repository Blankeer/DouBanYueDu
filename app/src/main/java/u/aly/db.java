...
public class db extends di {
    ...
    public void a(short s) throws cp {
        this.j[0] = (byte) ((s >> 8) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT);
        this.j[1] = (byte) (s & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT);
        this.g.b(this.j, 0, 2);
    }

    public void a(int i) throws cp {
        this.k[0] = (byte) ((i >> 24) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT);
        this.k[1] = (byte) ((i >> 16) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT);
        this.k[2] = (byte) ((i >> 8) & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT);
        this.k[3] = (byte) (i & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT);
        this.g.b(this.k, 0, 4);
    }
    ...
    public dg h() throws cp {
        ...
        if (w < 0) {
            if ((a & w) == b) {
                return new dg(z(), (byte) (w & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT), w());
            }
    ...
    public dd l() throws cp {
        byte u = u();
        return new dd(Table.STRING_DEFAULT_VALUE, u, u == null ? (short) 0 : v());
    }
    ...
    public short v() throws cp {
        ...
        return (short) ((bArr[i + 1] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) | ((bArr[i] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) << 8));
    }
    ...
    public int w() throws cp {
        ...
        return (bArr[i + 3] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) | ((((bArr[i] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) << 24) | ((bArr[i + 1] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) << 16)) | ((bArr[i + 2] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT) << 8));
    }
    ...
    public long x() throws cp {
        ...
        return ((long) (bArr[i + 7] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT)) | (((((((((long) (bArr[i] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT)) << 56) | (((long) (bArr[i + 1] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT)) << 48)) | (((long) (bArr[i + 2] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT)) << 40)) | (((long) (bArr[i + 3] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT)) << 32)) | (((long) (bArr[i + 4] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT)) << 24)) | (((long) (bArr[i + 5] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT)) << 16)) | (((long) (bArr[i + 6] & SettingsJsonConstants.SETTINGS_IDENTIFIER_MASK_DEFAULT)) << 8));
    }
    ...
    public String z() throws cp {
        ...
        try {
            String str = new String(this.g.f(), this.g.g(), w, HttpRequest.CHARSET_UTF8);
            this.g.a(w);
            return str;
        } catch (UnsupportedEncodingException e) {
            throw new cp("JVM DOES NOT SUPPORT UTF-8");
