...
public class f {
    ...
    public static class a {
        ...
        public int b(int i) {
            return (this.b != -1 && this.b >= 0 && this.b <= 1800) ? this.b * AppUri.OPEN_URL : i;
        }
        ...
        public int[] a(int i, int i2) {
            ...
            if (this.e == -1 || this.e < 90 || this.e > StatConstant.DEFAULT_FORCE_UPLOAD_SECOND) {
                this.e = 90;
            }
            return new int[]{this.d, this.e * AppUri.OPEN_URL};
        }
        ...
        public int d(int i) {
            return (this.g == -1 || this.g < 90 || this.g > StatConstant.DEFAULT_FORCE_UPLOAD_SECOND) ? i : this.g * AppUri.OPEN_URL;
        }
