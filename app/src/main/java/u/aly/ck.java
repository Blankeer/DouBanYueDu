...
public final class ck {
    ...
    public static void a(ByteBuffer byteBuffer, StringBuilder stringBuilder) {
        ...
        if (limit - position > TransportMediator.FLAG_KEY_MEDIA_NEXT) {
            arrayOffset = position + TransportMediator.FLAG_KEY_MEDIA_NEXT;
        } else {
            arrayOffset = limit;
        }
    ...
    public static String a(byte b) {
        return Integer.toHexString((b | WorksIdentity.ID_BIT_FINALIZE) & 511).toUpperCase().substring(1);
    }
